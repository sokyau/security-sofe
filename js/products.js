// Base de datos de productos de Sofe Security (Mock B2B)
// Nota: Todos los datos técnicos están basados en arquitecturas reales,
// precios y certificaciones específicas están marcados como "Por confirmar".
...
const PRODUCTS_DATA = [
  {
    ...
    specifications: {
      ...
      "Alimentación": "Hi-PoE / 24 VAC (Inyector por confirmar)",
      "Certificaciones": "CE, FCC, UL (Listado completo por confirmar)",
      "Garantía de Fábrica": "3 Años (Por confirmar)"
    },
  ...
  },
  {
    ...
    specifications: {
      ...
      "Arquitectura": "Cliente-Servidor (Windows / Linux por confirmar)",
      "Base de Datos": "PostgreSQL / MS SQL Server",
      "Actualizaciones Incluidas": "12 meses de soporte y parches (Por confirmar)",
  ...
  },
  {
    ...
    specifications: {
      "Capacidad Máxima": "Hasta 352TB brutos (Por confirmar)",
      "Procesador": "Intel Xeon Multicore Enterprise",
      "Memoria RAM": "64GB DDR4 ECC ECC Registrada (Expandible por confirmar)",
  ...
  },
  {
    ...
    specifications: {
      "Procesador": "Intel Xeon Silver / Gold (Configuración exacta por confirmar)",
      "GPU Aceleradora": "Nvidia RT A4000 16GB o equivalente (Por confirmar)",
      "Memoria RAM": "128GB DDR4 ECC RDIMM",
      "Almacenamiento OS": "2x 960GB SSD Enterprise RAID 1",
      "Garantía": "Soporte en sitio 24/7 por confirmar"
    },
  ...
  },
  {
    ...
    features: [
      ...
      "Factor de potencia de salida de 0.9 o superior (Por confirmar)",
    ...
    specifications: {
      ...
      "Rango de Voltaje de Entrada": "80V - 150V AC (Por confirmar)",
      "Tiempo de Transferencia": "0 ms (Doble conversión permanente)",
      "Autonomía típica": "15 minutos a media carga (Expandible con módulos por confirmar)",
  ...
  },
  {
    ...
    specifications: {
      "Voltaje Nominal": "110V / 220V Autorregulable (Por confirmar)",
      "Corriente Máxima": "16A total",
      "Conexión de Entrada": "NEMA L5-20P o IEC C20 (Por confirmar)",
  ...
  },
  {
    ...
    features: [
      ...
      "Capacidad de carga estática de hasta 1200 kg (Por confirmar)",
      "Entradas de cable superiores e inferiores protegidas contra polvo"
    ],
    specifications: {
      "Unidades de Rack": "42U",
      "Dimensiones externas": "2000mm alto x 600mm ancho x 1000mm profundidad (Por confirmar)",
  ...
  },
  {
    ...
    specifications: {
      ...
      "Diámetro exterior": "8.5 mm nominal (Por confirmar)",
      "Resistencia a la tensión": "1500 N máxima de instalación (Por confirmar)",
      "Rango de Temperatura Operativa": "-40°C a +70°C",
      "Presentación": "Bobina de madera (longitud por confirmar)"
    },
  ...
  },
  {
    ...
    features: [
      ...
      "Certificación Fluke Channel certificable a 500MHz (Por confirmar)"
    ],
    specifications: {
      "Categoría de Red": "Categoría 6A (F/UTP o U/UTP por confirmar)",
  ...
  },
  {
    ...
    specifications: {
      ...
      "Tiempo de Vida Mínimo": "50,000 horas continuas (Por confirmar)",
      "Entradas / Salidas": "2x HDMI, 1x DP In, 1x DP Out, 1x DVI-D, RS232C, RJ45",
      "Garantía Comercial": "3 años en sitio (Por confirmar)"
    },
  ...
  },
  {
    ...
    features: [
      ...
      "Se vende en kit de 100 piezas con fundas protectoras incluidas (Por confirmar)"
    ],
    specifications: {
      "Tipo de Conector": "RJ45 (8P8C) Blindado (FTP)",
      "Categoría certificada": "Cat6A / Cat7",
      "Cantidad por empaque": "100 conectores + 100 botas (Por confirmar)",
